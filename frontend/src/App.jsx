...
export default function App() {
  ...
  toast((expandedHistory.has(item.version) ? 'Collapsed ' : 'Expanded ') + 'v' + item.version);
  }
  ...
  <Toaster position="top-right" toastOptions={{style:{background:'#1f2a36',color:'#c9d1d9',border:'1px solid #2b3947'}}} />
