...
if (!convexUrl) {
  console.error(
    "Convex URL not configured. Set VITE_CONVEX_URL in .env.local."
  );
  createRoot(rootEl).render(
    ...
    >
      ...
      <p>
        No Convex endpoint found. Create a file <code>.env.local</code> with:
      </p>
      <pre
        style={{
          background: "#111",
